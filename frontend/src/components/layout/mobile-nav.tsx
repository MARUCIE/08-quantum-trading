 ...
 * Mobile Navigation
 *
 * Responsive navigation drawer for mobile devices with collapsible groups.
 */
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="w-64 p-0 flex flex-col">
        ...
        <nav aria-label="Mobile secondary navigation" className="space-y-1 px-3 py-3 shrink-0">
