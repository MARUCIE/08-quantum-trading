...
| D82 | DELETE /api/risk/events + Docker CORS 修复 | clearEvents() REST endpoint 暴露；.env.example CORS 增加 port 3008；97/97 chromium PASS | curl -X DELETE 204 + Playwright 97/97 | commits `1fd4f05` + `739b41d` |
